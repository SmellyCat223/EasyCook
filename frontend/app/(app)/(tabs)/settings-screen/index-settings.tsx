...
const Settings = () => {
    ...
    return (
        <View className="flex-1 bg-stone-950">
            <ProfilePicture />
            <View className="py-4">
                <Button2 text="Go to my profile" icon1="account-circle" icon2="chevron-right" onPress={handlePress} path="./components/profile" />
                <Button2 text="Go to inventory" icon1="inventory" icon2="chevron-right" onPress={handlePress} path="./components/inventory" />
