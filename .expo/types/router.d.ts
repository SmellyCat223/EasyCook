...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/_sitemap` | `/components/button` | `/components/button2` | `/components/inventory` | `/components/login` | `/components/profile` | `/components/profile-picture` | `/grocery` | `/home-screen` | `/home-screen/components/article` | `/home-screen/components/expiring` | `/home-screen/components/group-request` | `/home-screen/components/header` | `/home-screen/components/next-meal` | `/home-screen/components/search` | `/home-screen/components/stats` | `/home-screen/components/update-inventory` | `/meal-planner` | `/mealPlanner-screen` | `/mealPlanner-screen/components/headerDate` | `/mealPlanner-screen/components/threeMealsADay` | `/recipe` | `/recipe-screen` | `/recipe-screen/components/header` | `/recipe-screen/components/recipe-first` | `/recipe-screen/components/search-bar` | `/settings-screen`;
